...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    private Button btnOpenChat, btnChangeEmail, btnChangePassword, btnSendResetEmail, btnRemoveUser,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get current user
        final FirebaseUser user = FirebaseHelper.getCurrentUser();
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(AccountSettingsActivity.this, SignInActivity.class));
                    finish();
                }
            }
        };

        btnOpenChat = (Button) findViewById(R.id.openChat);
        ...
        btnOpenChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AccountSettingsActivity.this, ChatActivity.class));
                finish();
            }
        });
